...
categories: ["Personal"]
tags: ["Garry's Mod", "Level Design", "Source Engine", "WW3RP", "Multiplayer", "Environment Art", "Optimization"]
series: ["Personal"]
series_order: 4
date: 2016-10-21
---
...
<div class="project-brief">
  <article>
    ...
    <p>A public Garry's Mod role-play map for the nebulous.cloud community.</p>
  </article>
  <article>
    <span>Focus</span>
    <strong>Large-scale combat space</strong>
    <p>A large battlefield split into recognizable compounds, trenches, roads, bridges, forests, and caves rather than one enormous empty snowfield.</p>
  </article>
  <article>
    <span>Stack</span>
    <strong>Garry's Mod and Source mapping</strong>
    <p>Source Engine mapping with custom textures, destructible structures, interactive spaces, and a great deal of visibility work.</p>
  </article>
</div>

{{< keywordList >}}
{{< keyword >}} Garry's Mod {{< /keyword >}}
{{< keyword >}} Source Engine {{< /keyword >}}
{{< keyword >}} WW3RP {{< /keyword >}}
...
![An aerial view of a fortified trench compound in rp_wartorn](screenshot1.jpg)

*Fortified compounds and trench networks broke the terrain into places players could recognize, attack, and defend.*

![A huge concrete bridge crossing the snowy valley](screenshot2.jpg)
...
![A waterfall surrounded by a snowy pine forest](screenshot3.jpg)
...
![The intact exterior wall of a destructible building](screenshot_destructible_1.jpg)

*Before: a closed wall protecting the interior.*

![The same exterior wall after a large opening has been destroyed](screenshot_destructible_2.jpg)
