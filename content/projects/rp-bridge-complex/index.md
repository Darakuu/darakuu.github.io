...
categories: ["Personal"]
tags: ["Garry's Mod", "Level Design", "Source Engine", "WW3RP", "Multiplayer", "Atmos"]
series: ["Personal"]
series_order: 5
date: 2016-08-02
---
...
<div class="project-brief">
  <article>
    ...
    <p>A Garry's Mod level made for one specific nebulous.cloud WW3RP event rather than years of general-purpose play.</p>
  </article>
  <article>
    <span>Focus</span>
    <strong>Bridge, complex, and flanking network</strong>
    <p>A direct fight over the bridge and main complex, with a large sewer network giving players another way through.</p>
  </article>
  <article>
    <span>Stack</span>
    <strong>Garry's Mod and Source mapping</strong>
    <p>My first full Garry's Mod mapping project, with Atmos support and no unnecessary AI node graph for a player-only event.</p>
  </article>
</div>
...
![A large Complex filled with pipes](screenshot1.jpg)
...
![A damaged railway crossing the upper level of the bridge](screenshot2.jpg)
...
![A multi-level industrial combat space surrounding a railway](screenshot3.jpg)
...
![A dark red maintenance shaft beneath the complex](screenshot4.jpg)
